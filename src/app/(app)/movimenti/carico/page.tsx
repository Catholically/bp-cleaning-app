      ...
      <div className="max-w-4xl mx-auto px-4 -mt-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-center text-lg font-semibold"
          />
        </div>
